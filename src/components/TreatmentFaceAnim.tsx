...
const TREATMENT_ANIM: Record<string, AnimConfig> = {
  ...
  'retatrutide':          { type: 'jawDefine',     timeline: '3–12 months' },
  'cagrilintide':         { type: 'jawDefine',     timeline: '3–9 months' },
  '5-amino-1mq':          { type: 'jawDefine',     timeline: '2–3 months' },
  'slu-pp-332':           { type: 'jawDefine',     timeline: 'experimental' },
