...
const SECTIONS: { title: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "If you believe you were billed in error, contact us at support@sourcestack.app and we'll sort it out. Refund requests are handled case by case.",
    ],
  },
  {
  ...
  },
  {
    title: "8. Changes",
    body: [
      "We may update these terms as the service evolves. Material changes will be reflected on this page with continued use constituting acceptance. Questions: support@sourcestack.app.",
    ],
  },
];
