...
const SYNONYM_MAP: Record<string, string[]> = {
  ...
  // GLP-1 / fat loss
  glp: ["glp-1", "semaglutide", "tirzepatide", "retatrutide", "body fat", "fat loss"],
  "glp-1": ["semaglutide", "tirzepatide", "retatrutide", "ozempic", "body fat", "fat loss"],
  "glp 1": ["glp-1", "semaglutide", "tirzepatide", "retatrutide", "fat loss"],
  ...
  retatrutide: ["reta", "glp-1", "triple agonist", "body fat", "fat loss"],
  reta: ["retatrutide", "glp-1", "fat loss", "body fat"],
  "triple agonist": ["retatrutide", "glp-1", "fat loss"],
  cagrilintide: ["cagri", "cagrisema", "amylin", "body fat", "fat loss"],
  cagri: ["cagrilintide", "cagrisema", "fat loss"],
  cagrisema: ["cagrilintide", "semaglutide", "fat loss", "body fat"],
  amylin: ["cagrilintide", "fat loss"],
  "5-amino-1mq": ["nnmt", "oral fat loss", "body fat", "fat loss"],
  "5 amino": ["5-amino-1mq", "fat loss", "body fat"],
  nnmt: ["5-amino-1mq", "fat loss"],
  "slu-pp-332": ["slu pp 332", "exercise mimetic", "err agonist", "fat loss"],
  "exercise mimetic": ["slu-pp-332", "fat loss"],
  "fat loss": ["body fat", "retatrutide", "tirzepatide", "semaglutide", "tesamorelin", "jawline"],
  "body fat": ["fat loss", "retatrutide", "tirzepatide", "semaglutide", "jawline definition"],
  "weight loss": ["body fat", "fat loss", "retatrutide", "semaglutide", "tirzepatide"],
